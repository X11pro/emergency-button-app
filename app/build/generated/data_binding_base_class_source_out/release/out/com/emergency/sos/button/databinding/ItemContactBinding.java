...
public final class ItemContactBinding implements ViewBinding {
  ...
  private ItemContactBinding(@NonNull MaterialCardView rootView, @NonNull TextView contactName,
  ...
  public static ItemContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemContactBinding((MaterialCardView) rootView, contactName, contactPhone,
          removeButton);
    }
